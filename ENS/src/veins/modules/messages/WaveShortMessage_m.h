...
/**
 * Class generated from <tt>veins/modules/messages/WaveShortMessage.msg:30</tt> by nedtool.
 * <pre>
...
class WaveShortMessage : public ::cPacket
{
  protected:
    ...
    int serial_var;
    Coord senderPos_var;
    int lastFrameReceived_var;
    int idVideo_var;
    double speed_var;
    opp_string nodeType_var;
  ...
  public:
    ...
    virtual int getLastFrameReceived() const;
    virtual void setLastFrameReceived(int lastFrameReceived);
    virtual int getIdVideo() const;
    virtual void setIdVideo(int idVideo);
