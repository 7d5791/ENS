...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->lastFrameReceived_var = other.lastFrameReceived_var;
    this->idVideo_var = other.idVideo_var;
...
void WaveShortMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->lastFrameReceived_var);
    doPacking(b,this->idVideo_var);
...
void WaveShortMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->lastFrameReceived_var);
    doUnpacking(b,this->idVideo_var);
...
int WaveShortMessage::getLastFrameReceived() const
{
    return lastFrameReceived_var;
}

void WaveShortMessage::setLastFrameReceived(int lastFrameReceived)
{
    this->lastFrameReceived_var = lastFrameReceived;
}

int WaveShortMessage::getIdVideo() const
{
    return idVideo_var;
}

void WaveShortMessage::setIdVideo(int idVideo)
{
    this->idVideo_var = idVideo;
}
...
const char * WaveShortMessage::getNodeType() const
{
    return nodeType_var.c_str();
}

void WaveShortMessage::setNodeType(const char * nodeType)
{
...
int WaveShortMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='l' && strcmp(fieldName, "lastFrameReceived")==0) return base+13;
    if (fieldName[0]=='i' && strcmp(fieldName, "idVideo")==0) return base+14;
    if (fieldName[0]=='s' && strcmp(fieldName, "speed")==0) return base+15;
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeType")==0) return base+16;
...
std::string WaveShortMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 13: return long2string(pp->getLastFrameReceived());
        case 14: return long2string(pp->getIdVideo());
        case 15: return double2string(pp->getSpeed());
        case 16: return oppstring2string(pp->getNodeType());
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 13: pp->setLastFrameReceived(string2long(value)); return true;
        case 14: pp->setIdVideo(string2long(value)); return true;
        case 15: pp->setSpeed(string2double(value)); return true;
        case 16: pp->setNodeType((value)); return true;
