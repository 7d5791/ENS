...
public:
    BeaconList();
    void AddBeacon(int b_idMsg, std::string b_typeNode, std::string b_status, simtime_t b_time, simtime_t b_timeRx, int b_idVehicle,double b_s, double b_pX, double b_pY, double b_pZ,
    ...
    void UpdateBeacon(int b_idMsg, std::string b_typeNode,std::string b_status, simtime_t b_time,simtime_t b_timeRx, int b_idVehicle,double b_s, double b_pX, double b_pY, double b_pZ,
            double b_disJunction,double b_disToSource, double b_disToDestination, simtime_t b_idleTime, double b_abe, double b_angle);
