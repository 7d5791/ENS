...
WaveShortMessage*  BaseWaveApplLayer::prepareWSM(std::string name, int lengthBits, t_channel channel, int priority, int rcvId, int serial, double speed) {
	...
	wsm->setNodeType(this->getClassName());
